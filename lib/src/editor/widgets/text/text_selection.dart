...
class _TextSelectionHandleOverlayState
  ...
  void _handleDragUpdate(DragUpdateDetails details) {
    ...
    // Resolve the text position from _dragPosition (anchored above the
    // handle), not the raw finger position: the handle hangs below the line,
    // so the raw position hits the line underneath and makes horizontal
    // drags jump a line down (upstream PR #2731).
